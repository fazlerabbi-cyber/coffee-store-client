...
const AddCoffee = () => {
  ...
  return (
    ...
    <h2 className='text-3xl font-bold'>Add To Coffee</h2>
    ...
    <div className='md:flex gap-5'> 
      <div className='form-control w-full'>
        ...
        <label className='input-group'>
          ...
          <input type="text" name="photo" placeholder='Photo URS' className='input input-bordered w-full' id="" />
        </label>

      </div>
    </div>
    <input type="submit" value="Add Coffee" className='btn btn-block my-8 bg-purple-400' />
  </form>
</div>
  )
}
